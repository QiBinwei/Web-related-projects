...
<div id="body">
            ...
            <section id="review-content">
				...
				<%
					...
					DBCollection hotels = db.getCollection("GetAwayCelebrations");
				...
				%>
                     ...
                     <form method="post"  action="addgetawaycelebrations?req=update">

					<table width="100%">
					<tr>
					<td>
						<h1 style="color: #777;border-bottom: 2px solid #777;margin-left:15px">Update Party Hall</h1>
					</td>
					</tr>
					</table>
                        <table class="form-table" width=90%>							
							...
							<tr>
                                ...
                                <td><input type="number" name="capacity" value = "<%= obj.getString("capacity")%>" class="login-input" style="width:250px; height:25px" required/> </td>
