...
<div id="body">
            ...
            <section id="review-content">
                ...
                <article>
                     ...
                     <form method="post"  action="addgetawaycelebrations">

					<table width="100%">
					<tr>
					<td>
						<h1 style="color: #777;border-bottom: 2px solid #777;margin-left:15px">Add New Party Hall</h1>
					</td>
					</tr>
					</table>
                        <table class="form-table" width=90%>							
							...
							<tr>
								<td class="left-row"> Hall type<span style="color:red">*</span> : </td>
                                <td><select  name="hall" class="login-input" style="width:250px; height:25px" required/>
								...
								<td> </td>
								<td class="left-row">Capacity<span style="color:red">*</span> : </td>
                                <td><input type="number" name="capacity" value = "" class="login-input" style="width:250px; height:25px" required/> </td>
							...
							<td class="left-row">Price<span style="color:red">*</span> : </td>
                                <td><input type="number" name="price" min="100" value = "" class="login-input" style="width:250px; height:25px" required/> </td>
								<td> </td>
							</tr>
							<tr>
