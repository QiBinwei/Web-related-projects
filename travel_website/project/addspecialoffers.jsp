...
<div id="body">
            ...
            <section id="review-content">
				...
				%>
                     ...
                     <form method="post"  action="addspecialoffers">

					<table width="100%">
					<tr>
					<td>
						<h1 style="color: #777;border-bottom: 2px solid #777;margin-left:15px">Add Special Offers</h1>
					</td>
					</tr>
					</table>
                        <table class="form-table" width=90%>							
							...
							<tr>
                                ...
                                <td><input type="text" name="offerId" value = "" class="login-input" style="width:250px; height:25px" required/> </td>
						    </tr>
							...
							<tr>
                                ...
                                <td><input type="number" name="minNo" value = "" class="login-input" style="width:250px; height:25px" required/> </td>
								
                            </tr>
							
							<tr>
								<td class="left-row">Discount percentage<span style="color:red">*</span> : </td>
                                <td><input type="number" name="percent" value = "" class="login-input" style="width:250px; height:25px" required/> </td>
