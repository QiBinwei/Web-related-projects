...
<div id="container">
    ...
    <nav>
        <nav>
            <ul>
                ...
                <li class="start selected"><a href="allProducts.php">All Products</a></li>
	...
	<section id="content">
        ...
        <?php cart();?>
	    <div class="cart">
         <span style="float: right; margin-right: 40px;">Welcome Guest!&nbsp&nbsp&nbsp<b>Shopping Cart-&nbsp&nbsp</b>Total Items:&nbsp &nbsp Total Pirce:&nbsp&nbsp
		...
		<ul>
              ...
              $get_pro = "select * from products where product_desc like '%$search_query%'";
