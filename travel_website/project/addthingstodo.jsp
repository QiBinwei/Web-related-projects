...
<div id="body">
            ...
            <section id="review-content">
                ...
                <article>
					...
					<tr>
					<td>
						<h1 style="color: #777;border-bottom: 2px solid #777;margin-left:15px">Add New Things To Do</h1>
					</td>
					</tr>
					</table>
                        <table class="form-table" width=90%>							
							...
							<tr>
                                ...
                                <td><input type="text" name="eventId" value = "" class="login-input" style="width:250px; height:25px" required/> </td>
								<td> </td>
								<td class="left-row">Event Title<span style="color:red">*</span> : </td>
                                <td><input type="text" name="eventName" value = "" class="login-input" style="width:250px; height:25px" required/> </td>
							...
							<tr>
                                ...
                                <td><select name="city" style="width:252px; height:25px" required/>
