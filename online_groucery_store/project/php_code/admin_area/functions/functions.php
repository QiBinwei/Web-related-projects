...
function getInfo(){
	...
	$get_info = "select * from customers where customer_id=2";
...
function getStaffInfo(){
	...
	$get_info = "select * from staff where staff_id=1";
...
function getWarehouseInfo(){
	...
	$get_info = "select * from warehouse where warehouse_id=1";
	...
	while ($row_info=mysqli_fetch_array($run_info)){
		...
		$warehouse_address = $row_info['warehouse_address'];
		$warehouse_capacity = $row_info['warehouse_capacity'];


		echo "<table>";
		echo"<tr><td>Warehouse Name:</td><td><h2>$warehouse_name</h2></td></tr>";	
		echo"<tr><td>Warehouse address:</td><td><h2>$warehouse_address</h2></td></tr>";	
		echo"<tr><td>Warehouse capacity</td><td><h2>$warehouse_capacity cubic feet</h2></td></tr>";
...
function getSupplierInfo(){
	...
	$get_info = "select * from suppliers where supplier_id=1";
	...
	while ($row_info=mysqli_fetch_array($run_info)){
		//while loop to fetch every element in the two column
		$supplier_name = $row_info['supplier_name'];
		$supplier_address = $row_info['supplier_address'];
		$supplier_item = $row_info['supplier_item'];
		$supplier_price = $row_info['supplier_price'];


		echo "<table>";
		echo"<tr><td>Supplier Name:</td><td><h2>$supplier_name</h2></td></tr>";	
		echo"<tr><td>Supplier address:</td><td><h2>$supplier_address</h2></td></tr>";	
		echo"<tr><td>Supplier item</td><td><h2>$supplier_item </h2></td></tr>";
		echo"<tr><td>Supplier price</td><td><h2>$ $supplier_price /lb </h2></td></tr>";
