...
<!-- INDEX -->
 <head>
    ...
    <body>
        ...
        <a href="insert_product.php"><li class="BG1">Insert Products</li></a>
        <a href="edit_product.php"><li class="BG2">Edit Products</li></a>
        <a href="delete_Product.php"><li class="BG3">Delete Products</li></a>
